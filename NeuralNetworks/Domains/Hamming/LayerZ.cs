...
public class LayerZ : BaseLayer
{
    private readonly Matrix _w;  //weights matrix of connections of S-layer to Z-layer
    private readonly double _k1; // constant param // k1 = 1 / (amount of S-neurons + 1)
    public LayerZ(double epsilon, int countOfNeurons, IReadOnlyList<Matrix> samples, double k1 = 0) : base(epsilon)
    {
        _k1 = k1 switch
        {
            > 0 => k1,
