...
using NeuralNetworks.Domains.Hamming;
...
public partial class Hamming : Form
{
    ...
    private HammingNn _hammingNeuralNetwork;
    ...
    {
        _hammingNeuralNetwork = new HammingNn(Epsilon, PictureBoxHeightInNeurons * PictureBoxWidthInNeurons, _samples);
        var results = _hammingNeuralNetwork.GetIndexes(Converter.ImageToVector(pictureBox1.Image));
